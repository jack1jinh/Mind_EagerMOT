...
from config.local_variables import MOUNT_PATH, SPLIT
from dataset.nuscenes.classes import id_from_name as id_nuscenes_from_name
from dataset.kitti.classes import id_from_name as id_kitti_from_name
