...
import utils.mot_dataset as mot_dataset
import utils.mot_sequence as mot_sequence
import utils.mot_frame as mot_frame
import utils.io as io
from config.local_variables import KITTI_DATA_DIR
import engine.loading as loading
import engine.utils as utils
from engine.detections_2d import CAR_CLASS, PED_CLASS
from engine.bbox import Bbox2d, Bbox3d
from engine.detection_2d import Detection2D
from utils.fused_instance import FusedInstance
import dataset.kitti.reporting as reporting
from models.kitti import TransformationKitti
from models.transformation import to_homogeneous
...
class MOTSequenceKITTI(mot_sequence.MOTSequence):
    def __init__(self, det_source: str, seg_source: str, split_dir: str, split: str,
        ...
        self.ego_motion_transforms = np.ones(shape=(len(self.frame_names), 4, 4), dtype=np.float32)
